...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tnmall', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Condors\\TnMallBundle\\Entity'))), 'Condors\\TnMallBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('CondorsTnMallBundle' => 'Condors\\TnMallBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4c72895abaeff7a27ffff9a6331b287d53048b3fb28b3b384732fb83c7bb5d7b');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Condors\\TnMallBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Condors\\TnMallBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Condors\\TnMallBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Condors\\TnMallBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Condors\\TnMallBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Condors\TnMallBundle\Redirection\AfterLoginRedirection A Condors\TnMallBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \Condors\TnMallBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/responsable/register');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/resetting');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user-responsable/');
        ...
        $n->add($k, array(0 => 'ROLE_RESPONSABLE'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('condors.group@gmail.com');
        $a->setPassword('pwdpwd@123');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Condors\\TnMallBundle/Resources/views'), 'CondorsTnMall');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_RESPONSABLE' => array(0 => 'ROLE_RESPONSABLE'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CondorsTnMallBundle' => 'Condors\\TnMallBundle\\CondorsTnMallBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'tnmall',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'condors.group@gmail.com',
            'mailer_password' => 'pwdpwd@123',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'condors.group@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'pwdpwd@123',
            ...
            'fos_user.model.user.class' => 'Condors\\TnMallBundle\\Entity\\User',
