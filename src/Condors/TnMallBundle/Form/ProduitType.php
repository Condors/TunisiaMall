    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('categorieProduit', 'entity', array(
                'class' => 'CondorsTnMallBundle:Categories',
                'property' => 'name',
                'query_builder' => function (\Condors\TnMallBundle\Entity\CategoriesRepository $repository) {
                    return

                        $repository->createQueryBuilder('k')
                            ->innerJoin('k.idEnseigne', 'lo')
                            ->where('lo.idresponsableenseigne =:respoId')
